...
class Octant:  #children = 9, center: center of the cube;  extent: 0.5* length 中心点到一个面的距离; point_indices: Point inside octant
    def __init__(self, children, center, extent, point_indices, is_leaf):
        self.children = children
        self.center = center  ## 3维中心点
        self.extent = extent
