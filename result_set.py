...
class KNNResultSet:
    def __init__(self, capacity):
        ...
        self.dist_index_list = []  ## 包含点集的list,每个点都有worst_dist
    ...
    def add_point(self, dist, index):  ## 往容器里面加点，把worst distance 加进去，并排序
        self.comparison_counter += 1  ## 计算迭代次数
        ...
        i = self.count - 1
        while i > 0:     ## 
            if self.dist_index_list[i-1].distance > dist:   ##根据worst distance从小到大排序
